      ...
      <div className="max-w-xl mx-auto">
        ...
        <div className="mt-10 mb-4">
          ...
          <p className="text-neutral-500 text-sm mt-1">
            ...
            <span className="text-stone-400 font-mono">Part no.</span> and{" "}
            <span className="text-stone-400 font-mono">Location</span> columns
            to bulk update locations.
          </p>
        </div>
        ...
        >
          {locFile ? (
            <div className="text-center">
              ...
              <p className="text-neutral-500 text-xs mt-1">
                {(locFile.size / 1024).toFixed(1)} KB — Click to change
              </p>
            </div>
          ) : (
            <div className="text-center">
        ...
        {locResult && (
          <div className="mt-4 p-5 bg-neutral-900 border border-neutral-800 rounded-xl space-y-2">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Stat
                label="Updated"
                value={locResult.updated}
                color="text-green-400"
              />
              <Stat
                label="Not Found"
                value={locResult.notFound}
                color="text-neutral-500"
              />
            </div>
            {locResult.errors?.length > 0 && (
              <div className="mt-3 border-t border-neutral-800 pt-3">
                <p className="text-red-400 text-xs font-bold mb-2">
                  ⚠ {locResult.errors.length} error(s):
                </p>
                <div className="space-y-1 max-h-32 overflow-y-auto">
        ...
        <div className="mt-4 mb-8 p-4 bg-neutral-900 border border-neutral-800 rounded-xl">
          ...
          <p className="text-xs text-neutral-500 mb-3">
            First row must use these exact column names:
          </p>
          <div className="overflow-x-auto">
            <table className="w-full text-xs">
              <thead>
                <tr className="border-b border-neutral-700">
                  <th className="text-left py-2 pr-4 text-amber-400 font-medium">
                    Column
                  </th>
                ...
                {[
                  ...
                  <tr key={col} className="border-b border-neutral-800/50">
                    <td className="py-1.5 pr-4">
                      <span
                        className={`font-mono ${col === "partNo" ? "text-amber-400" : "text-stone-400"}`}
                      >
                        {col}
                      </span>
                      {col === "partNo" && (
